...
var ToastProvider = exports.ToastProvider = function (_Component) {
  ...
  _createClass(ToastProvider, [{
    ...
    value: function render() {
      ...
      var containerStyles = toasts.length ? null : { pointerEvents: 'none' };
      ...
      return _react2.default.createElement(
        ...
        canUseDOM ? (0, _reactDom.createPortal)(_react2.default.createElement(
          ToastContainer,
          { placement: placement, style: containerStyles },
          _react2.default.createElement(
            ...
            toasts.map(function (_ref) {
              var appearance = _ref.appearance,
                  ...
                  unknownConsumerProps = _objectWithoutProperties(_ref, ['appearance', 'autoDismiss', 'content', 'id', 'onDismiss', 'pauseOnHover']);
        ...
        ), document.body) : _react2.default.createElement(ToastContainer, { placement: placement, style: containerStyles }) // keep ReactDOM.hydrate happy
...
var useToasts = exports.useToasts = function useToasts() {
  var _useContext = (0, _react.useContext)(ToastContext),
      add = _useContext.add,
      remove = _useContext.remove,
      toasts = _useContext.toasts;

  return { addToast: add, removeToast: remove, toasts: toasts };
};